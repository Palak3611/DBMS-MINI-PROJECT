...
class Library:
    ...
    def __init__(self,root):
        ...
        TitleFrame =Frame(MainFrame,width=1450,padx=10,bd=10,relief=RIDGE)
        TitleFrame.pack(side=TOP)
       
        self.lblTitle =Label(TitleFrame,width=39,font=('Times New Roman',35,'bold'),text="\tLibrary Management System\t",bg="PowderBlue",fg='Black',padx=12)
        self.lblTitle.grid()
